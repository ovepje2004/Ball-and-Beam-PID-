...
#define _DUTY_MAX 2309 // 2000
#define _DUTY_NEU 1747 // 1500
#define _DUTY_MIN 1185 // 1000
...
#define _KD 130     // derivative gain
...
float volt_to_distance(int a_value)
{
  ...
  return (1769.0 - 12.8 * a_value + 0.0341 * a_value * a_value
          - 3.18E-05 * a_value * a_value * a_value);
}
