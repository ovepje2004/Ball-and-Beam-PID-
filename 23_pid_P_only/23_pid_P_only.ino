...
#define _INTERVAL_DIST    60 // distance sensor interval (unit: ms)
...
#define _DUTY_MAX 2291 // 2000
#define _DUTY_NEU 1587 // 1500
#define _DUTY_MIN 883 // 1000

#define _SERVO_ANGLE_DIFF  145   // Replace with |D - E| degree
...
// PID parameters
#define _KP  3.3    // proportional gain
...
float volt_to_distance(int a_value)
{
  ...
  return 533 + (-1.68 * x) + (4.55 * 0.0001 * x * x) + (4.28 * 0.000001 * x * x * x) + (-4.6 * 0.000000001 * x * x * x * x);
}
