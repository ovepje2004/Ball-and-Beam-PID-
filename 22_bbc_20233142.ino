...
#define _DUTY_MAX 2301 // 2000
#define _DUTY_NEU 1542 // 1500
#define _DUTY_MIN 783 // 1000

#define _SERVO_ANGLE_DIFF  105 // Replace with |D - E| degree
#define _SERVO_SPEED       300  // s....ervo speed

#define _BANGBANG_RANGE    550  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 734 + (-3.32 * a_value) + (5.8 * 0.001 * a_value * a_value) + (-3.77 * 0.000001 * a_value * a_value * a_value);
}
